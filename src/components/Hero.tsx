...
export default function Hero() {
  ...
  if (loading) {
    return (
      <div className="space-y-4">
        ...
        <div className="relative w-full h-125 sm:h-[calc(100vh-64px)]">
  ...
  return (
    <div className="space-y-2 mb-24">
      {/* Главный баннер */}
      {currentMovie && (
        <div className="relative overflow-hidden h-125 sm:h-screen">
                        ...
                        <Link href={`/about/${getMovieId(movie)}`}>
                          <div className="relative group rounded-2xl">
                            <img
                              ...
                              className="w-full h-75 object-cover rounded-2xl transition-transform group-hover:scale-105"
                              onError={(e) => {
